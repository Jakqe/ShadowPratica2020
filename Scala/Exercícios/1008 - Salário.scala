...
object Main {
    ...
    def main(args: Array[String]) {
     ...
     var horasTrabalhadas:Int = scala.io.StdIn.readInt()
     var valorPorHora:Double = scala.io.StdIn.readDouble()
     println("NUMBER = " + (n))
     println("SALARY = U$ %.2f".format(valorPorHora * horasTrabalhadas))
